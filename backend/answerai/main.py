...
from answerai.config import (
    ...
    # Email Verification
    ENABLE_EMAIL_VERIFICATION_CONFIG,
    SMTP_HOST_CONFIG,
    SMTP_PORT_CONFIG,
    SMTP_USERNAME_CONFIG,
    SMTP_PASSWORD_CONFIG,
    SMTP_FROM_EMAIL_CONFIG,
    SMTP_USE_TLS_CONFIG,
    # Misc
    ENV,
    CACHE_DIR,
...
app.state.config.ENABLE_EMAIL_VERIFICATION_CONFIG = ENABLE_EMAIL_VERIFICATION_CONFIG
app.state.config.SMTP_HOST_CONFIG = SMTP_HOST_CONFIG
app.state.config.SMTP_PORT_CONFIG = SMTP_PORT_CONFIG
app.state.config.SMTP_USERNAME_CONFIG = SMTP_USERNAME_CONFIG
app.state.config.SMTP_PASSWORD_CONFIG = SMTP_PASSWORD_CONFIG
app.state.config.SMTP_FROM_EMAIL_CONFIG = SMTP_FROM_EMAIL_CONFIG
app.state.config.SMTP_USE_TLS_CONFIG = SMTP_USE_TLS_CONFIG
